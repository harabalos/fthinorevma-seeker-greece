      ...
      questions: [
        {
          ...
          answer: "Η διαδικασία ολοκληρώνεται συνήθως σε 5-20 ημέρες από την υποβολή της αίτησης. Ο χρόνος εξαρτάται από τον τρέχοντα και τον νέο πάροχο. Θα σας ενημερώνουμε για την πρόοδο σε κάθε στάδιο."
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "Ναι, μπορείτε να αλλάξετε ξανά πάροχο όποτε θελήσετε. Μπορεί να υπάρχουν δεσμεύσεις ή ποινές διακοπής ανάλογα με το πρόγραμμα και το χρώμα που έχετε επιλέξει. Η αγορά ρεύματος είναι πλήρως ελευθεροποιημένη."
        }
      ]
    },
    {
